    ...
    public unsafe static class PipelineFunctions
    {
        ...
        public static void InitRenderTarget(ref RenderTargets tar, Camera tarcam, CommandBuffer buffer)
        {
            ...
            foreach (var i in RenderTargets.gbufferIndex)
                RenderPipeline.ReleaseRTAfterFrame(i);
            RenderPipeline.ReleaseRTAfterFrame(ShaderIDs._DepthBufferTexture);
            RenderPipeline.ReleaseRTAfterFrame(ShaderIDs._CameraDepthTexture);
            RenderPipeline.ReleaseRTAfterFrame(ShaderIDs._BackupMap);
            RenderPipeline.ReleaseRTAfterFrame(ShaderIDs._CameraMotionVectorsTexture);
